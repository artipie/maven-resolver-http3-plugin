package com.artipie.maven.wagon.providers.http;
    ...
    extends StreamWagon
{
    ...
    LightweightHttpWagon() {
        super();
        System.out.println("LightweightHttpWagon created()!!!");
        System.err.println("LightweightHttpWagon created()!!!");
    }
    ...
    {
        System.err.println("LightweightHttpWagon.fillInputData() called() !!! " + buildUrl(inputData.getResource()));
